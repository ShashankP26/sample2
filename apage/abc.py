...
from .models import Profile, UserActivityLog ,GroupButton
...
# Unregister the Profile model if it's already registered (to avoid double registration)
try:
    admin.site.unregister(Profile)
except admin.sites.NotRegistered:
    pass  # Profile is not registered yet, so we ignore the error
